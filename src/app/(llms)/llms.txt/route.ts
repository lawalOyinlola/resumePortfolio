...
- [Experience](${SITE_INFO.url}/experience.md): Highlights from my career and the roles I've taken on.
- [Projects](${SITE_INFO.url}/projects.md): Selected projects that show my skills and range.

 ...
 *
 * ⚠️ The two entries below are SAMPLES so you can see the layout — replace them
 * with real recommendations (LinkedIn "Recommendations", a manager/teammate
 * quote, a tweet, etc.) and never ship the placeholders. The whole section
 * hides automatically when this array is empty.
 *
 * Tip: set `url` to the source (e.g. the LinkedIn recommendation permalink or
